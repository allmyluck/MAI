...
Вариант 28: 8-угольник, квадрат, треугольник.
*/
    ...
    */
    ...
    while(std::cin >> term) {
        if (term == "quit") {
            ...
            std::string temp;
            std::cout << "o - octagon,t - triangle,s - square" << std::endl;
            std::cin >> temp;
            if(temp == "o") {
                double x,y,R;
                ...
                std::cin >> x >> y >> R;
                try {
                    figures.push_back(std::make_shared<Octagon<double>>(x,y,R));
